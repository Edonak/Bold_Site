// app/page.jsx (ou pages/index.jsx si vous utilisez un ancien routeur)
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 max-w-5xl">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-gray-700 mt-4">
              <strong>BOLD</strong> est une Association Sans But Lucratif poursuivant
              la vision d’un monde de dignité pour toutes les femmes et les filles.
            </p>
            <p className="text-lg md:text-xl text-gray-700 mt-4">
              Notre mission est de renforcer, accompagner et soutenir les femmes et
              filles pour la construction des communautés inclusives et équitables.
            </p>
            <p className="text-lg md:text-xl text-gray-700 mt-4">
